    ...
    @if (auth()->user()->can('admin.personal'))
        <div class="margen-principal">
            ...
            <div style="display: flex; justify-content: space-between">
                ...
                <div>
                    <button class="btn btn-success" style="font-weight: 500; font-size: 15px; color: white;" data-bs-toggle="modal" data-bs-target="#staticBackdropusuario">Agregar Empleado</button> 
                </div>
            </div>
